...
/**
 * ZKDialogFragmentHelper
 * 参考：https://github.com/gdky005/DialogFragmentDemos/blob/master/app/src/main/java/com/example/haoz/dialogfragmentdemos/utils/DialogFragmentHelper.java
 * Created by WangQing on 2017/12/22.
 */

public class ZKCommonDialogFragmentHelper {
    private static final String DIALOG_POSITIVE = "确定";
    private static final String DIALOG_NEGATIVE = "取消";

    private static final String TAG_HEAD = ZKCommonDialogFragmentHelper.class.getSimpleName();
    ...
    public static ZKDialogFragment showProgress(FragmentManager fragmentManager, String message) {
        return showProgress(fragmentManager, message, true, null);
    }

    public static ZKDialogFragment showProgress(FragmentManager fragmentManager, String message, boolean cancelable) {
        return showProgress(fragmentManager, message, cancelable, null);
    }

    public static ZKDialogFragment showProgress(FragmentManager fragmentManager, final String message, boolean cancelable,
                                                OnZKDialogCancelListener cancelListener) {
    ...
    public static void showConfirmDialog(FragmentManager fragmentManager, final String message, final ZKDialogResultListener<Integer> listener
            , boolean cancelable, OnZKDialogCancelListener cancelListener){
        ZKDialogFragment dialogFragment = ZKDialogFragment.newInstance(new OnZKCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
    ...
    public static ZKDialogFragment showListDialog(FragmentManager fragmentManager, final String title, final String[] items
            , final ZKDialogResultListener<Integer> resultListener, boolean cancelable ){
        ZKDialogFragment dialogFragment = ZKDialogFragment.newInstance(new OnZKCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
    ...
    public static ZKDialogFragment showDateDialog(FragmentManager fragmentManager, final String title, final Calendar calendar
            , final ZKDialogResultListener<Calendar> resultListener, final boolean cancelable){
        ZKDialogFragment dialogFragment = ZKDialogFragment.newInstance(new OnZKCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
    ...
    public static void showTimeDialog(FragmentManager manager, final String title, final Calendar calendar, final ZKDialogResultListener<Calendar> resultListener, final boolean cancelable){
        ZKDialogFragment dialogFragment = ZKDialogFragment.newInstance(new OnZKCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
    ...
    public static void showInsertDialog(FragmentManager manager, final String title, final ZKDialogResultListener<String> resultListener, final boolean cancelable){
    ...
    public static void showPasswordInsertDialog(FragmentManager manager, final String title, final ZKDialogResultListener<String> resultListener, final boolean cancelable){
        ZKDialogFragment dialogFragment = ZKDialogFragment.newInstance(new OnZKCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
                final EditText editText = new EditText(context);
